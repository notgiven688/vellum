...
public partial class Application
{
    ...
    public static void UpdateFrame(double browserFrameTimestampMs = double.NaN)
    {
        ...
        ui.Theme = ResolveDemoTheme(state.SelectedTheme);
...
static Theme ResolveDemoTheme(int selectedTheme) => selectedTheme switch
{
    1 => ThemeCache.Light,
    _ => ThemeCache.Dark
};
...
static void RunHeadlessBench()
{
    ...
    {
        ui.Theme = ResolveDemoTheme(demoState.SelectedTheme);
